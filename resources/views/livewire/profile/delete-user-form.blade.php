...
<section class="space-y-6">
    ...
    <x-button label="{{ __('Delete Account') }}" class="btn-error" onclick="confirmUserDeletion.showModal()" />

    <x-modal id="confirmUserDeletion">
        <form wire:submit="deleteUser" class="p-6">
            ...
            <div class="mt-6 flex justify-end">
                <x-secondary-button onclick="confirmUserDeletion.close()">
                    {{ __('Cancel') }}
                </x-secondary-button>
